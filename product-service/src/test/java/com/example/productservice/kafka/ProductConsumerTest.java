...
//        productConsumer = new ProductConsumer(objectMapper, productService);
//    }
//
//    @Test
...
//
//        productConsumer.handleProductEvent(jsonMessage, "products");
//
//        verify(productService, times(1)).handleProductEventFromKafka(productEvent, false);
//    }
//
//    @Test
...
//
//        assertDoesNotThrow(() -> productConsumer.handleProductEvent(invalidJsonMessage, "products"));
//
//        verify(productService, never()).handleProductEventFromKafka(any(), anyBoolean());
//    }
//
//    @Test
...
//
//        assertDoesNotThrow(() -> productConsumer.handleProductEvent(emptyMessage, "products"));
//
//        verify(productService, never()).handleProductEventFromKafka(any(), anyBoolean());
//    }
//
...
//        when(objectMapper.readValue(jsonMessage, Product.class)).thenReturn(productEvent);
//
//        productConsumer.handleProductEvent(jsonMessage, "products-topic");
//
//        verify(productService, times(1)).handleProductEventFromKafka(productEvent, true);
//    }
//
//    @Test
...
//                .thenThrow(new com.fasterxml.jackson.core.JsonParseException(null, "Invalid JSON"));
//
//        assertDoesNotThrow(() -> productConsumer.handleProductEvent(invalidJsonMessage, "products-topic"));
//
//        verify(productService, never()).handleProductEventFromKafka(any(), anyBoolean());
//    }
//
...
//                .thenThrow(new com.fasterxml.jackson.core.JsonParseException(null, "No content"));
//
//        assertDoesNotThrow(() -> productConsumer.handleProductEvent(emptyMessage, "products-topic"));
//
//        verify(productService, never()).handleProductEventFromKafka(any(), anyBoolean());
//    }
//
...
//        when(objectMapper.readValue(jsonMessage, Product.class)).thenReturn(productEvent);
//
//        assertDoesNotThrow(() -> productConsumer.handleProductEvent(jsonMessage, "products-topic"));
//
//        verify(productService, times(1)).handleProductEventFromKafka(productEvent, true);
//    }
//
